...
class ViewParagraph extends AbstractHelper {
	const APPEND = 'append';
	...
	/**
	 * Generate a view Paragraph, optionally with content
	 *
	...
	/**
	 * Generate an opening Paragraph tag
	 *
	...
	/**
	 * Return a closing Paragraph tag
	 *
	 * @return string
	 */
